...
class __TwigTemplate_70a336804c68fbe74a136e19d689a0cd extends Template
{
    private $source;
    private $macros = [];
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/notifier.html.twig", "/var/www/html/latitur/vendor/symfony/web-profiler-bundle/Resources/views/Collector/notifier.html.twig");
    }
}

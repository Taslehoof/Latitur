...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Form\\CategoriaFormType' => ['privates', 'App\\Form\\CategoriaFormType', 'getCategoriaFormTypeService', true],
            'App\\Form\\ExcelImportarType' => ['privates', 'App\\Form\\ExcelImportarType', 'getExcelImportarTypeService', true],
            'App\\Form\\LoginType' => ['privates', 'App\\Form\\LoginType', 'getLoginTypeService', true],
            'App\\Form\\PersonaEntityType' => ['privates', 'App\\Form\\PersonaEntityType', 'getPersonaEntityTypeService', true],
            'App\\Form\\PersonaUploadType' => ['privates', 'App\\Form\\PersonaUploadType', 'getPersonaUploadTypeService', true],
            'App\\Form\\PersonaValidationType' => ['privates', 'App\\Form\\PersonaValidationType', 'getPersonaValidationTypeService', true],
            'App\\Form\\ProductoFormType' => ['privates', 'App\\Form\\ProductoFormType', 'getProductoFormTypeService', true],
            'App\\Form\\ProductoFotoType' => ['privates', 'App\\Form\\ProductoFotoType', 'getProductoFotoTypeService', true],
            ...
            'App\\Form\\CategoriaFormType' => '?',
            'App\\Form\\ExcelImportarType' => '?',
            'App\\Form\\LoginType' => '?',
            'App\\Form\\PersonaEntityType' => '?',
            'App\\Form\\PersonaUploadType' => '?',
            'App\\Form\\PersonaValidationType' => '?',
            'App\\Form\\ProductoFormType' => '?',
            'App\\Form\\ProductoFotoType' => '?',
